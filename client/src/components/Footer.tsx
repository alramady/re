      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-4">{aboutText}</p>
            {/* Contact info */}
            <div className="space-y-2 text-sm text-white/60">
              ...
              {phone && (
                <a href={`tel:${phone}`} className="flex items-center gap-2 hover:text-white transition-colors" dir="ltr">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              ...
              <li><Link href="/search?city=madinah" className="hover:text-white transition-colors">{t("city.madinah")}</Link></li>
              <li><Link href="/search?city=khobar" className="hover:text-white transition-colors">{t("city.khobar")}</Link></li>
            </ul>
            ...
            {(twitter || instagram || linkedin) && (
              <div className="mt-4 pt-4 border-t border-white/10">
                <div className="flex gap-3">
                  ...
                  {instagram && (
                    <a href={instagram} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
