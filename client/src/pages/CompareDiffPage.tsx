      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-3 mb-6">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            <GitCompareArrows className="w-6 h-6 text-[#F2A44E]" />
            عدسة الأثر والحقوق
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          <GlassCard delay={0} tilt>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#F2A44E]/10 flex items-center justify-center"><Scale className="w-5 h-5 text-[#F2A44E]" /></div>
              <div>
                <p className="text-2xl font-bold text-white">6</p>
                <p className="text-xs text-white/40">حقوق قيد التحليل</p>
              </div>
            </div>
          </GlassCard>
          <GlassCard delay={1} tilt>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/40">متوسط الامتثال</p>
              </div>
            </div>
          </GlassCard>
          <GlassCard delay={2} tilt>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/40">فجوات حرجة</p>
              </div>
            </div>
          </GlassCard>
        </div>
        ...
        <GlassCard>
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-base font-bold text-white flex items-center gap-2">
              <FileText className="w-5 h-5 text-[#F2A44E]" />
            ...
            {rightsAnalysis.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-4 rounded-xl bg-white/2 hover:bg-white/4 transition-colors"
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      <h4 className="text-sm font-bold text-white">{item.right}</h4>
                      <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#F2A44E]/10 text-[#F2A44E]">{item.article}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="text-sm font-bold text-white w-12 text-left">{item.compliance}%</span>
                  </div>
                  <p className="text-xs text-white/50">{item.gap}</p>
                </motion.div>
              );
            })}
          </div>
